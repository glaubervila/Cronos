/**
 * @package     : Clientes
 * @name        : Tipo_Cliente_Grid
 * @version     : 1.0
 * @Diretorio   : Main/Modulos/Clientes/
 * @Dependencias: Tipo_Cliente_Form.js
 * @date        : 30/03/2011
 */

var Tipo_Cliente_Grid = Ext.extend(Ext.grid.GridPanel,{

    $depends     : ['Tipo_Cliente_Form.js']
    , id         : 'Tipo_Cliente_Grid'
    , identificacao : '4003' // Identificacao para permissoes

    , main_url   : 'main.php'
    , main_class : 'Tipo_Cliente'
    , pk_id      : 'pk_tipo_cliente'
    , metodo_load: 'load_tipos_clientes'
    ...
    , constructor: function() {
        ...
        Tipo_Cliente_Grid.superclass.constructor.apply(this,arguments);
    }
    ...
    ,initComponent: function() {
        ...
        Tipo_Cliente_Grid.superclass.initComponent.call(this);
    }

    , initEvents: function() {
        Tipo_Cliente_Grid.superclass.initEvents.call(this);
    ...
    , onDestroy: function() {
        ...
        Tipo_Cliente_Grid.superclass.onDestroy.apply(this,arguments);
        //destroi a janela
    ...
    , _criaWindowForm: function() {
        ...
        */
        if(!this._winForm) {
            this._winForm = new Tipo_Cliente_Form({
                renderTo   : this.body
                , listeners  :{
                    scope  : this
...
Ext.reg('e-Tipo_Cliente_Grid', Tipo_Cliente_Grid);