/**
 * @package     : Clientes
 * @name        : Tipo_Cliente_Form
 * @version     : 1.0
 * @Diretorio   : Main/Modulos/Clientes/
 * @date        : 30/03/2011
 */
var Tipo_Cliente_Form = Ext.extend(Ext.Window,{

    id: 'Tipo_Cliente_Form'
    , identificacao : '5004' // Identificacao para permissoes

    , main_url   : 'main.php'
    , main_class : 'Tipo_Cliente'
    , pk_id      : 'pk_tipo_cliente'
    , metodo_load  : 'get_tipo_cliente'
    , metodo_delete: 'delete_tipo_cliente'
    ...
    , constructor: function() {
        ...
        Tipo_Cliente_Form.superclass.constructor.apply(this,arguments);
    }
    ...
    , initComponent: function() {
        ...
        Tipo_Cliente_Form.superclass.initComponent.call(this);
    }
     ...
     */
    , show: function() {
        Tipo_Cliente_Form.superclass.show.apply(this,arguments);
        ...
        if(this.IdRegistro !== 0) {
            ...
            this.formPanel.getForm().load({
                ...
                , params : {
                    ...
                    , 'pk_tipo_cliente': this.IdRegistro
                }
                , scope: this
    ...
    , onDestroy: function() {
        Tipo_Cliente_Form.superclass.onDestroy.apply(this,arguments);
        this.formPanel = null;
    }
