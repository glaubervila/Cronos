 ...
 * @Dependencias: Produtos_Form.js
 * @date        : 24/11/2010
 * @version     : 1.0
 */

var Produtos_Grid = Ext.extend(Ext.grid.GridPanel,{

    $depends     : ['Produtos_Form.js']
    , id         : 'Produtos_Grid'
    ...
    , constructor: function() {
        ...
        Produtos_Grid.superclass.constructor.apply(this,arguments);
    }
    ...
    ,initComponent: function() {
        ...
        Produtos_Grid.superclass.initComponent.call(this);
    }

    , initEvents: function() {
        Produtos_Grid.superclass.initEvents.call(this);
    ...
    , onDestroy: function() {
        ...
        Produtos_Grid.superclass.onDestroy.apply(this,arguments);
        //destroi a janela
    ...
    , _criaWindowForm: function() {
        ...
        */
        if(!this._winForm) {
            this._winForm = new Produtos_Form({
                //renderTo   : this.body
                listeners  :{
                    scope  : this
...
Ext.reg('e-Produtos_Grid', Produtos_Grid);