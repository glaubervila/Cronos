 ...
 * @Dependencias: Categoria_Form.js
 * @date        : 23/11/2010
 */

var Categoria_Grid = Ext.extend(Ext.grid.GridPanel,{

    $depends     : ['Categoria_Form.js']
    , id         : 'Categoria_Grid'
    ...
    , constructor: function() {
        ...
        Categoria_Grid.superclass.constructor.apply(this,arguments);
    }
    ...
    ,initComponent: function() {
        ...
        Categoria_Grid.superclass.initComponent.call(this);
    }

    , initEvents: function() {
        Categoria_Grid.superclass.initEvents.call(this);
    ...
    , onDestroy: function() {
        ...
        Categoria_Grid.superclass.onDestroy.apply(this,arguments);
        //destroi a janela
    ...
    , _criaWindowForm: function() {
        ...
        */
        if(!this._winForm) {
            this._winForm = new Categoria_Form({
                renderTo   : this.body
                , listeners  :{
                    scope  : this
...
Ext.reg('e-Categoria_Grid', Categoria_Grid);