...
var Lojas_Grid = Ext.extend(Ext.grid.GridPanel,{

    $depends     : ['Lojas_Form.js']
    , border     : false
    , stripeRows : true
    , loadMask   : true
    ...
    ,initComponent: function() {
        ...
        // Store de Grupos
        var storeGruposLojas = new Ext.data.JsonStore({
            url              : 'main.php'
            , root           : 'rows'
            , idProperty     : 'id'
            //, autoLoad       : true
        ...
        Ext.apply(this,{
            ...
            , {
                ...
                , width     : 100
                , sortable  : true
                , renderer  : this.Renderers.grupos_lojas
            },{
                dataIndex   : 'nome'
                , header    : 'Loja'
                , width     : 100
        ...
        Lojas_Grid.superclass.initComponent.call(this);
    }

    , initEvents: function() {
        Lojas_Grid.superclass.initEvents.call(this);
    ...
    , onDestroy: function() {
        Lojas_Grid.superclass.onDestroy.apply(this,arguments);
        //destroi a janela
...
//         teste = permissoes_store.findExact('identificacao','manutencao_lojas');
//         bla = permissoes_store.getAt(teste);
//         alert(bla.data.ins);
//         //teste2 = teste.items(0).data.id;
...
Ext.reg('e-Lojas_Grid', Lojas_Grid);